...
from database import fetch_all, fetch_one, execute, check_document_exists, check_case_exists
    ...
    documents = [
        {
            ...
            "is_reserved": bool(row.get("is_reserved", False)),
            "is_public": row.get("document_type_visibility") == "publico",
        }
